...
def main():
    ...
    print(f"Total experiments: {len(TEST_SEEDS) * len(FOCUSED_RANGES) * 4}")  # 4 operations
    ...
    output_file = Path("experiment_results") / f"focused_frozen_results_{timestamp}.json"
