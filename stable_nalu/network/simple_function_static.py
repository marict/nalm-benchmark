...
from ..layer import BasicLayer, GeneralizedLayer
...
class SimpleFunctionStaticNetwork(ExtendedTorchModule):
    ...
    def __init__(
        ...
        **kwags,
        ...
        if nac_mul == "mnac":
            ...
            unit_name_2 = "NPU"
        elif nac_mul == "real-npu":
            unit_name_2 = "RealNPU"
        else:
            unit_name_2 = unit_name

        self.layer_2 = GeneralizedLayer(
            hidden_size,
            1,
    ...
    def forward(self, input):
        ...
        if (
            self.nac_mul == "none"
            or self.nac_mul == "mnac"
            or self.nac_mul == "npu"
            or self.nac_mul == "real-npu"
        ):
    ...
    def extra_repr(self):
        return "unit_name={}, input_size={}".format(self.unit_name, self.input_size)
