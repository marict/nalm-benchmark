...
class BasicLayer(ExtendedTorchModule):
    ...
    def __init__(
        self, in_features, out_features, activation="linear", bias=True, **kwargs
    ):
    ...
    def forward(self, input, reuse=False):
        ...
        self.writer.add_scalar(
            "W/sparsity_error", sparsity_error(self.W), verbose_only=False
        )
        return self.activation_fn(torch.nn.functional.linear(input, self.W, self.bias))
