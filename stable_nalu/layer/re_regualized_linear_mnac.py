...
from ..functional import Regualizer, RegualizerNMUZ, mnac, sparsity_error
...
class ReRegualizedLinearMNACLayer(ExtendedTorchModule):
    ...
    def forward(self, x, reuse=False):
        ...
        W = (
            torch.clamp(self.W, 0.0 + self.mnac_epsilon, 1.0)
        ...
        self.writer.add_tensor(
            "W", W, verbose_only=False if self.use_robustness_exp_logging else True
        )
