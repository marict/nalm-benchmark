...
from ..functional import RegualizerNAUZ, nac_weight, sparsity_error
...
class NACLayer(ExtendedTorchModule):
    ...
    def __init__(
        self, in_features, out_features, regualizer_z=0, nac_weight="normal", **kwargs
    ):
        super().__init__("nac", **kwargs)
        self.in_features = in_features
        self.out_features = out_features
        self.nac_weight = nac_weight
    ...
    def regualizer(self):
        W = nac_weight(self.W_hat, self.M_hat, mode=self.nac_weight)
